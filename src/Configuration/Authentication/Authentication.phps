...
namespace Playground\Make\Postman\Configuration\Postman;
// src/Configuration/Postman/Authentication/Authentication.php
use Playground\Make\Configuration;

/**
 * \Playground\Make\Postman\Configuration\Postman\Item
 */
class Item extends Configuration\Configuration implements Configuration\Contracts\WithSkeleton
{
